...
curl https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/king-vpn/autoscript-vip/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
